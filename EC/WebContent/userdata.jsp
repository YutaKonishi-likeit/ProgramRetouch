				...
				<div class="card grey lighten-5">
					<div class="card-content">
						<table class="bordered">
							...
							<tbody>
								<%
									for (BuyDataBeans userBuy : userBuyList) {
								%>
								<tr>
									<td class="center"><a href="UserBuyHistoryDetail?buy_id=<%=userBuy.getId()%>" class="btn-floating btn waves-effect waves-light "> <i class="material-icons">details</i></a></td>
									<td class="center"><%=userBuy.getFormatDate()%></td>
									<td class="center"><%=userBuy.getDeliveryMethodName()%></td>
									<td class="center"><%=userBuy.getTotalPrice()%>円</td>
								</tr>
								<%
									}
								%>
